        ...
        <Col style={mid}>
            <form className="form-floating" style={{maxWidth: '450px', margin: 'auto', border: '1px solid black', paddingBottom: '2rem'}} >
                ...
                <div className="form-floating" style={{maxWidth: '260px', margin: 'auto', height: '40px'}}>
                    ...
                    <label htmlFor="floatingInputId" style={{padding: '0.5rem 0.75rem'}} maxLength='20'>아이디</label>
                </div>
                ...
                <div className="form-floating" style={{maxWidth: '260px', margin: 'auto', height: '40px'}}>
                    ...
                    <input type="text" name='name' className="form-control" id="floatingInputName" placeholder="사용자 이름" style={{height: '40px', padding: '0.7rem 0.75rem 0'}} />
                    <label htmlFor="floatingInputName" style={{padding: '0.5rem 0.75rem'}} maxLength='10'>사용자 이름</label>
                </div>
                <div style={{height: '20px', marginBottom: '5px'}}>
                  <small>test2</small>
                </div>
                ...
                <div className="form-floating" style={{maxWidth: '260px', margin: 'auto', height: '40px'}}>
                    <input type={showPwd ? "text" : "password"} name='pwd' className="form-control" id="floatingInputPassword" placeholder="비밀번호" ref={inputPwd} style={{height: '40px', padding: '0.7rem 0.75rem 0'}}
                    onChange={(e) => {
                      inputPwdChange();
                    }}
                       />
                    <label htmlFor="floatingInputPassword" style={{padding: '0.5rem 0.75rem'}} maxLength='20'>비밀번호</label>
                ...
                <div className="form-floating" style={{maxWidth: '260px', margin: 'auto', height: '40px'}}>
                    <input type="email" name='email' className="form-control" id="floatingInputEmail" placeholder="name@example.com" style={{height: '40px', padding: '0.7rem 0.75rem 0'}} />
                    <label htmlFor="floatingInputEmail" style={{padding: '0.5rem 0.75rem'}} maxLength='100'>이메일 주소</label>
                </div>
                <div style={{height: '20px', marginBottom: '5px'}}>
                  <small>test4</small>
                </div>
                ...
                <div className="form-floating" style={{maxWidth: '260px', margin: 'auto', height: '40px'}}>
                    <input type="tel" name='phone' className="form-control" id="floatingInputPhone" placeholder="010-0000-0000" style={{height: '40px', padding: '0.7rem 0.75rem 0', width: '80%', display: 'inline'}} />
                    <label htmlFor="floatingInputPhone" style={{padding: '0.5rem 0.75rem'}} maxLength='15'>핸드폰 번호</label>
                ...
                <div className="form-floating" ref={phoneCertifiDiv} style={{maxWidth: '260px', margin: 'auto', height: '40px', marginBottom: '5px', visibility: 'hidden'}}>
                    <input type="text" name='phoneCertifi' className="form-control" id="floatingInputCertifiNum" placeholder="000000" style={{height: '40px', padding: '0.7rem 0.75rem 0', width: '80%', display: 'inline'}} />
                    <label htmlFor="floatingInputCertifiNum" style={{padding: '0.5rem 0.75rem'}} maxLength='10'>인증번호</label>
